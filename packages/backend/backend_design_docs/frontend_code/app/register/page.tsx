...
export default function Register() {
  ...
  const selectedCompany = watch("company") as string | undefined;
  ...
  async function onSubmit(values: any) {
    try {
      ...
      if (values.company?.toUpperCase() === "WFG") {
        userAttributes["custom:uplineEVC"] = values.uplineEVC ?? "";
        userAttributes["custom:uplineSMD"] = values.uplineSMD ?? "";
      }
          ...
          <div className="w-full max-w-xs">
            <form className="flex flex-col gap-6" onSubmit={handleSubmit(onSubmit)}>
              ...
              <div className="grid gap-4">
                ...
                {selectedCompany?.toUpperCase() === 'WFG' && (
                  <>
                    <div className="grid gap-2">
                      <Label htmlFor="uplineEVC">Upline EVC</Label>
                      <Input
                        id="uplineEVC"
                        placeholder="Enter your direct upline EVC"
                        {...register('uplineEVC', { required: true })}
                      />
                    </div>
                    <div className="grid gap-2">
                      <Label htmlFor="uplineSMD">Upline SMD</Label>
                      <Input
                        id="uplineSMD"
                        placeholder="Enter your direct upline SMD"
                        {...register('uplineSMD', { required: true })}
                      />
                    </div>
                  </>
                )}
